...
const Footer = () => <SkewedSection onTop background='var(--purple)' border='var(--purple)'>
  <div class={styles.Content}>
    ...
    <p class={styles.Legal}>
      This site is created with solid.js, is open-source and licensed under <a href='https://creativecommons.org/licenses/by-nc-sa/4.0/'>Creative Commons BY-NC-SA 4.0</a>.
